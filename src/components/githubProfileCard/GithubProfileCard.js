...
export default function GithubProfileCard({prof, isDark}) {
              ...
              <div className="location-div">
                <span className="desc-prof">
                  ...
                  <svg
                    ...
                    className={`svg-inline--fa fa-location-arrow fa-w-16 octicon location-svg ${
                      isDark ? "location-svg-dark" : "location-svg-light"
                    }`}
                    role="img"
